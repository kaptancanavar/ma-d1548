...
class VibeDatasetPairwise(Dataset):
    def __init__(self, config, mode='train'):
        ...
        self.data_amount = config.get('data_amount', 10000000 if mode == 'train' else 28)
    ...
    def __getitem__(self, idx):
        ...
        undersampled = self.undersampled_file_list[entry['undersampled_idx']]
        fully = self.fully_file_list[entry['fully_idx']]
